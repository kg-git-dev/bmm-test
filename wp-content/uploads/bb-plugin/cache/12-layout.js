...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'585a7bf3ce12c',layout:'grid',pagination:'none',postSpacing:'30',postWidth:'542',matchHeight:1,isRTL:false});});$(window).on('load',function(){$('.fl-node-585a7bf3ce12c .fl-post-grid').masonry('reloadItems');});})(jQuery);