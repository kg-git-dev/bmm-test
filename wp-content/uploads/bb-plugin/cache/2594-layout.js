...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'586e11decfe96',layout:'grid',pagination:'none',postSpacing:'30',postWidth:'260',matchHeight:1,isRTL:false});});$(window).on('load',function(){$('.fl-node-586e11decfe96 .fl-post-grid').masonry('reloadItems');});})(jQuery);